  ...
  <div id="basisFunctionDetails">
    ...
    <transition name="fade" mode="out-in">
      <ul class="floorNav" v-show="scrolled > 400">
        ...
        <li v-on:click="smoothness(4000);"></li>
        <li v-on:click="smoothness(4800);"></li>
        <li v-on:click="smoothness(5600);"></li>
        <li v-on:click="smoothness(6400);"></li>
        <li v-on:click="smoothness(7200);"></li>
        <li v-on:click="smoothness(8000);"></li>
        <li v-on:click="smoothness(8800);"></li>
        <li v-on:click="smoothness(9600);"></li>
      </ul>
    </transition>
  </div>
</template>
